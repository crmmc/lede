这于2020.8.1 克隆的lean openwrt 19 (R20) 的完整源码，已经整合至今最新的feed包，为了防止后期版本迭代导致的错误。
已经注释掉了feeds的所有源。 加入了orangepi zero的wifi补丁，需要在menuconfig界面kernel-modules里找xr819的补丁并开启。
请使用Ubuntu 18编译此版本openwrt，在16上因为cmake和gcc版本导致中途ld出现错误，这错误弄得我一脸懵逼，无法理解，耽误了我很多时间。有时候正确的合适的编译系统能避免很多问题。
不要用root用户克隆！！！！警告！
可以使用vultr这类按小时计费的云主机服务提供商开台vps编译，环境好布置而且系统纯净，用完就销毁。买高性能的云主机编译省时省事，买双核的性价比最高了(自用推荐，非广告)
